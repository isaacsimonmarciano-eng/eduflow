...
import { ArrowRight, BookOpenCheck, ListTodo, Mic, PenLine, Sparkles, Users } from "lucide-react";
...
const STEPS = [
  {
    ...
    color: "#4f46e5",
    soft: "#eef2ff",
    title: "1. Le délégué dicte",
    text: "Après le cours, il colle ses notes de dictaphone : mots-clés, phrases en vrac, peu importe.",
  },
  {
    icon: Sparkles,
    color: "#d97706",
    soft: "#fffbeb",
    title: "2. L'IA rédige",
    text: "En un clic, les notes deviennent un résumé clair : un titre, quelques phrases et les points clés.",
  },
  {
    icon: BookOpenCheck,
    color: "#0d9488",
    ...
    text: "Le résumé est publié dans la matière du jour. Chacun le retrouve, jour par jour, même absent.",
  },
];
    ...
    <div className="min-h-screen bg-background">
        ...
        <div className="mx-auto grid w-full max-w-6xl gap-10 px-4 pb-16 pt-16 sm:px-6 sm:pt-20 lg:grid-cols-[1.15fr_1fr] lg:items-center lg:pb-24">
          <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
            <span className="inline-flex items-center gap-1.5 rounded-full border border-border bg-card px-3.5 py-1.5 text-xs font-bold text-foreground/80 shadow-sm">
              ✉️ Connexion par e-mail — toute la classe peut rejoindre
            </span>
            <h1 className="mt-5 font-display text-4xl font-bold leading-[1.08] tracking-tight sm:text-5xl lg:text-[3.4rem]">
              ...
              <span className="relative whitespace-nowrap">
                ...
                <span aria-hidden className="absolute inset-x-0 bottom-1 z-0 h-3.5 rounded-full bg-amber-300/70 sm:bottom-1.5" />
              </span>{" "}
              pour toute la classe.
            </h1>
            <p className="mt-5 max-w-lg text-lg leading-relaxed text-muted-foreground">
              Le délégué invite par e-mail, synchronise devoirs et emploi du temps depuis EcoleDirecte, et publie des
              résumés clairs. Chacun se connecte avec son e-mail.
            </p>
            <div className="mt-7 flex flex-wrap items-center gap-3">
              <Button asChild size="lg" className="rounded-full font-bold shadow-md">
                <Link to="/auth">
                  Rejoindre avec mon e-mail
                  <ArrowRight className="size-4" />
                </Link>
              </Button>
              <a
            ...
            <div className="mt-6 flex flex-wrap items-center gap-x-5 gap-y-2 text-sm text-muted-foreground">
              <span className="inline-flex items-center gap-1.5">
                <Users className="size-4 text-primary" /> Le délégué invite par e-mail
              </span>
              <span className="inline-flex items-center gap-1.5">
                <PenLine className="size-4 text-teal-600" /> Résumés vérifiés avant publication
              </span>
              <span className="inline-flex items-center gap-1.5">
                <ListTodo className="size-4 text-amber-600" /> Devoirs EcoleDirecte + manuels
              </span>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="pop-card overflow-hidden">
              ...
              <div className="p-6">
                ...
                <h3 className="mt-3 font-display text-xl font-bold">Le théorème de Thalès</h3>
                <p className="mt-2 text-sm leading-relaxed text-foreground/80">
                  Aujourd'hui on a appris à utiliser le théorème de Thalès pour calculer des longueurs dans les
                ...
                <div className="mt-5 rounded-2xl bg-indigo-50/70 p-3.5 text-xs leading-relaxed text-indigo-900/80">
                  <span className="mr-1">🎙️</span> Notes dictées : « Thalès, triangles semblables, exercice 34,
          ...
          <div className="grid items-center gap-0 lg:grid-cols-2">
            <div className="p-6 sm:p-10">
              <span className="inline-flex items-center gap-1.5 rounded-full bg-amber-100 px-3 py-1 text-xs font-bold text-amber-800">
                📋 Le récap des devoirs
              </span>
              <h2 className="mt-4 font-display text-3xl font-bold tracking-tight">Plus un seul devoir oublié</h2>
              <p className="mt-3 max-w-md text-muted-foreground">
                Le délégué synchronise les devoirs EcoleDirecte en un clic. Et si un prof ne note rien, on les ajoute à
                la main pour la classe.
              </p>
              <div className="mt-6 space-y-2.5">
                {[
                  ...
                  >
                    ...
                    <span
                      className={`rounded-full px-2.5 py-1 text-[11px] font-extrabold ${item.done ? "bg-emerald-100 text-emerald-700" : "bg-amber-100 text-amber-700"}`}
                    >
      ...
      <section id="comment" className="mx-auto w-full max-w-6xl px-4 py-16 sm:px-6 sm:py-20">
        <motion.div {...fadeUp} transition={{ duration: 0.45 }}>
          ...
          <p className="mx-auto mt-3 max-w-xl text-center text-muted-foreground">
            Le rituel du délégué : e-mail pour tous, EcoleDirecte en coulisses pour synchroniser.
          </p>
        </motion.div>
      ...
      <section className="mx-auto w-full max-w-6xl px-4 pb-16 sm:px-6 sm:pb-20">
        <motion.div {...fadeUp} transition={{ duration: 0.45 }}>
          ...
          <p className="mx-auto mt-3 max-w-xl text-center text-muted-foreground">
            Les résumés sont rangés par matière et triés par date. Un coup d'œil suffit pour retrouver le cours
            d'hier.
          </p>
        </motion.div>
        <motion.div
        ...
        >
          {SUBJECTS.map((s) => (
            <span
              ...
              style={{ color: s.color }}
            >
              <span className="flex size-6 items-center justify-center rounded-full text-xs" style={{ backgroundColor: s.soft }}>
                {s.emoji}
              </span>
              {s.label}
            </span>
      ...
      <section className="mx-auto w-full max-w-6xl px-4 pb-20 sm:px-6">
        ...
        >
          ...
          <div className="relative">
            <h2 className="font-display text-3xl font-bold tracking-tight sm:text-4xl">Prêt à ouvrir le cartable ?</h2>
            <p className="mx-auto mt-3 max-w-lg text-primary-foreground/85">
              Rejoins la classe avec ton e-mail — le délégué s'occupe d'EcoleDirecte pour les devoirs et l'emploi du
              temps.
            </p>
            <Button asChild size="lg" variant="secondary" className="mt-6 rounded-full font-bold shadow-sm">
              <Link to="/auth">
